...
class CalendarList extends Component {
  ...
  constructor(props) {
    ...
    if (this.props.current) {
      this.initialIndex = this.pastScrollRange;
    }
  }
  ...
  scrollToDay(d, offset, animated) {
    ...
    const size = this.props.horizontal
      ...
      : this.calendarHeight;
    let scrollAmount =
      size * this.pastScrollRange + diffMonths * size + (offset || 0);
  ...
  getItemLayout(data, index) {
    return {
      ...
      offset:
        (this.props.horizontal ? this.calendarWidth : this.calendarHeight) *
        index,
      index
    };
  }
    ...
    return (
      <FlatList
        ...
        style={[
          ...
          this.props.style,
          { marginTop: this.state.addMarginTop }
        ]}
