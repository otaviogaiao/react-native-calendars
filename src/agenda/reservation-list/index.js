...
class ReactComp extends Component {
  static propTypes = {
    ...
    //indicates that the reservation list should show the future days, default is true
    renderFutureDays: PropTypes.bool
  };
  ...
  updateReservations(props) {
    ...
    if (this.list && !dateutils.sameDate(props.selectedDay, this.selectedDay)) {
      ...
      this.list.scrollToOffset({
        ...
        animated: this.props.renderFutureDays
      });
    }
  ...
  getReservations(props) {
    ...
    let reservations = [];
    if (this.props.renderFutureDays) {
  ...
  render() {
    if (
      ...
      if (this.props.renderFutureDays && this.props.renderEmptyData) {
        return this.props.renderEmptyData();
      } else if (!this.props.renderFutureDays && this.props.renderEmptyDate) {
