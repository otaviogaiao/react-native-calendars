...
export default class AgendaView extends Component {
  ...
  renderReservations() {
    const data = this.props.items[
      this.state.selectedDay.toString("yyyy-MM-dd")
    ];
    return this.props.flatListProps ? (
      ...
      <ReservationsList
        ...
        renderFutureDays={this.props.renderFutureDays}
      />
    );
  }
        ...
        <Animated.View style={headerStyle}>
          <Animated.View
            ...
            <CalendarList
              ...
              hideExtraDays={
                this.props.hideExtraDays || this.state.calendarScrollable
              }
